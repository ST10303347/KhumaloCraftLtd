...
namespace KhumaloCraftLtd.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public ProductModelsController(IProductsService productsService)
        {
     ...
     /*   // GET: ProductModels/Details/5
        ...
        public async Task<IActionResult> Create([Bind("Id,productName,Price,Category,Availability,Description,ImagePath,IdentityUserId")] ProductModel productModel)
        {
